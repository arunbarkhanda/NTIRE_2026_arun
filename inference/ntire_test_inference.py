...
CONFIG = {
    # ── Models ────────────────────────────────────────────────────────────
    "base_model_path":     "/home/ubuntu/ntire_unet_v7.keras",
    "residual_model_path": "/home/ubuntu/ntire_refiner_v7.1.keras",

    # ── Directories ───────────────────────────────────────────────────────
    "input_dir":           "/home/ubuntu/LSDIR_DIV2K_Test_Sigma50",
    "output_base_only":    "/home/ubuntu/denoised_base_only",  # base model output
    "output_base_res":     "/home/ubuntu/denoised_base_res",   # base + residual output
    "log_path":            "/home/ubuntu/denoising_log.txt",
...
def run(cfg):
    ...
    # ── Create output dirs ────────────────────────────────────────────────
    os.makedirs(cfg["output_base_only"], exist_ok=True)
    ...
    print(f"Output 1 (base only): {cfg['output_base_only']}")
    print(f"Output 2 (base+res):  {cfg['output_base_res']}")
    ...
    for idx, fname in enumerate(all_files, 1):
        ...
        save_image(os.path.join(cfg["output_base_only"], fname), den1)
    ...
    print(f"\n{'='*70}")
    print(f"DONE!")
    print(f"  Base only images : {cfg['output_base_only']}/  ({len(all_files)} files)")
